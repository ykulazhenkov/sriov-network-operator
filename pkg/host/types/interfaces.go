...
type SriovInterface interface {
	...
	DiscoverSriovDevices(store.StoreManagerInterface) ([]sriovnetworkv1.InterfaceExt, error)
	...
	ConfigSriovInterfaces(store.StoreManagerInterface, []sriovnetworkv1.Interface, []sriovnetworkv1.InterfaceExt, map[string]bool) error
