...
func (mr *MockHostManagerInterfaceMockRecorder) BindDriverByBusAndDevice(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockHostManagerInterface) ConfigSriovInterfaces(arg0 store.StoreManagerInterface, arg1 []v1.Interface, arg2 []v1.InterfaceExt, arg3 map[string]bool) error {
	m.ctrl.T.Helper()
...
func (m *MockHostManagerInterface) DiscoverSriovDevices(arg0 store.StoreManagerInterface) ([]v1.InterfaceExt, error) {
	m.ctrl.T.Helper()
...
func (m *MockHostManagerInterface) ReadService(arg0 string) (*types.Service, error) {
	m.ctrl.T.Helper()
