...
func (s *sriov) DiscoverSriovDevices(storeManager store.StoreManagerInterface) ([]sriovnetworkv1.InterfaceExt, error) {
...
func (s *sriov) ConfigSriovInterfaces(storeManager store.StoreManagerInterface,
