...
func (m *MockHostHelpersInterface) ConfigSriovInterfaces(arg0 store.StoreManagerInterface, arg1 []v1.Interface, arg2 []v1.InterfaceExt, arg3 map[string]bool) error {
	m.ctrl.T.Helper()
...
func (m *MockHostHelpersInterface) DiscoverSriovDevices(arg0 store.StoreManagerInterface) ([]v1.InterfaceExt, error) {
	m.ctrl.T.Helper()
