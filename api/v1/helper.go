...
func (cr *OVSNetwork) RenderNetAttDef() (*uns.Unstructured, error) {
	...
	data.Data["OfportRequest"] = cr.Spec.OfportRequest
	data.Data["InterfaceType"] = cr.Spec.InterfaceType
	data.Data["ConfigurationPath"] = cr.Spec.ConfigurationPath
	data.Data["SocketFile"] = cr.Spec.SocketFile
	data.Data["LinkStateCheckRetries"] = cr.Spec.LinkStateCheckRetries
	data.Data["LinkStateCheckInterval"] = cr.Spec.LinkStateCheckInterval
